...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Se presentará más claro en un diagrama, pero antes se deben considerar los siguientes elementos:
    ...
    p.mb-4 En una tabla nunca deben existir TUPLAS repetidas, es decir, no debe haber más de una fila con exactamente los mismos valores en cada columna que otra fila de la misma tabla. En otras palabras, cada fila debe diferir al menos en un elemento (columna) en relación con las demás.
    ...
    p.mb-0 Nótese como los atributos #[b identificacion y numero_cuenta] tiene subrayada la palabra identificadora del atributo, representado así que ese atributo es la clave (que hace que se cumpla el criterio de unicidad) de su entidad.
    ...
    p.mb-5 Este último enfoque es el más empleado y recomendado por los diseñadores o analistas de #[em software], pues reduce, significativamente, la complejidad del diseño y facilita la relación con otras tablas o entidades. Por lo tanto, se usará cada vez que se tenga oportunidad de hacerlo.


    .container.tarjeta.tarjeta--blanca
      .tarjeta--container.row.mb-5
        .col-md.tarjeta.fondo-color-sistema-q.p-5
    ...
    p.mb-5 Cuando una relación de es uno a muchos y se mapea un modelo de base de datos relacional, la relación #[b titular] (rombo) se termina convirtiendo una columna de la tabla de los muchos.
